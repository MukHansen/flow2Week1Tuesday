...
public class Customer5 implements Serializable {
    ...
    private List<Address5> addresses = new ArrayList();

    public void addAddress(Address5 address) {
        addresses.add(address);
    }

    public List<Address5> getAddresses() {
        return addresses;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Customer5)) {
            return false;
        }
        Customer5 other = (Customer5) object;
